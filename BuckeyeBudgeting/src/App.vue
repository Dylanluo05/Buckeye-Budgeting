  ...
  <div id = "home-background-2">
    ...
    <div id = "budget-envelopes-section">
      <div class = "budget-envelope">
        ...
        <div class = "envelope-amount-left">Amount Left: <bold style = "margin-left: 3px">$200</bold></div>
        <div class = "envelope-monthly-allowance">Monthly Allowance: <bold style = "margin-left: 3px">$300</bold></div>
...
<style scoped>
  ...
  .home-background-1-image, .home-background-1-overlay {
      position: absolute;
      top: 0;
      bottom: 0;
      left: 0;
  ...
  #account-balance-section, #monthly-budget-section {
    height: 70%;
    width: 40%;
    display: flex;
    flex-direction: column;
  ...
  .envelope-amount-left, .envelope-monthly-allowance {
    height: 15%;
    width: 100%;
    background-color: whitesmoke;
    font-size: 16px;
